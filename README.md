...
| garment_mask.png         | Grounded SAM-2  | |
| garment.png              | Raw data        | In-shop garment image |
| person_agnostic.png      | Multiplication  | |
| person_mask.png          | Grounded SAM-2  | |
| person.png               | Raw data        | Image of a person wearing the corresponding garment |
| video_0_agnostic_sam.mp4 | Grounded SAM-2  | |
| video_0_agnostic.mp4     | Multiplication  | |
| video_0_densepose.mp4    | Detectron2      | DensePose UV coordinates for the human body of full-shot person video |
| video_0_mask.mp4         | OpenPose        | |
| video_0.mp4              | Raw data        | Full-shot person video |
| video_1_agnostic_sam.mp4 | Grounded SAM-2  | |
| video_1_agnostic.mp4     | Multiplication  | |
| video_1_densepose.mp4    | Detectron2      | DensePose UV coordinates for the human body of close-up person video |
| video_1_mask.mp4         | Grounded SAM-2  | |
